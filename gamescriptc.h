...
typedef Integer * IntegerArray;
typedef UnsignedInteger * UnsignedIntegerArray;
...
String getExeDirectoryPath() /* -> String path */ {
  String output = (String)_gsCProcedureGetExeDirectoryPath(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray defaultCameraGetVector() /* -> Number position [3] {x, y, z} */ {
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraGetVector(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}

NumberArray defaultCameraGetVersor() /* -> Number quaternion [4] {x, y, z, w} */ {
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraGetVersor(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray defaultCameraScreenToWorld(Number screenX, Number screenY, Number screenZ) /* -> Number worldPosition [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraScreenToWorld(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray defaultCameraWorldToScreen(Number worldX, Number worldY, Number worldZ) /* -> Number screenPosition [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraWorldToScreen(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}

NumberArray defaultCameraGetSideVector() /* -> Number sideVector [3] {x, y, z} */ {
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraGetSideVector(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}

NumberArray defaultCameraGetUpVector() /* -> Number upVector [3] {x, y, z} */ {
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraGetUpVector(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}

NumberArray defaultCameraGetLookAtVector() /* -> Number lookAtVector [3] {x, y, z} */ {
  NumberArray output = (NumberArray)_gsCProcedureDefaultCameraGetLookAtVector(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String pointerGetString(Number pointer) /* -> String string */ {
  ...
  String output = (String)_gsCProcedurePointerGetString(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String pointerGetSubstring(Number pointer, Number pointerCharsFirst, Number charsCount) /* -> String string */ {
  ...
  String output = (String)_gsCProcedurePointerGetSubstring(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
void gsmemset(Number pointer, Number pointerBytesFirst, Number value8Bit, Number bytesCount) {
  void * args[] = {
    _gsVoidPointerFromNumber(pointer),
    _gsVoidPointerFromNumber(pointerBytesFirst),
...
void gsmemcpy(Number pointerTarget, Number pointerTargetBytesFirst, Number pointerSource, Number pointerSourceBytesFirst, Number bytesCount) {
  void * args[] = {
...
Bool gsmemcmp(Number pointerA, Number pointerABytesFirst, Number pointerB, Number pointerBBytesFirst, Number bytesCount) /* -> Bool areEqual */ {
  void * args[] = {
    _gsVoidPointerFromNumber(pointerA),
...
String keyboardGetGlfwCodepointString() /* -> String codepoint */ {
  String output = (String)_gsCProcedureKeyboardGetGlfwCodepointString(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray gamepadGet15Buttons6AxesNumbers(Number gamepadId0to15) /* -> Number buttonsAndAxes [21] {a, b, x, y, leftBumper, rightBumper, back, start, guide, leftThumb, rightThumb, dpadUp, dpadRight, dpadDown, dpadLeft, axisLeftX, axisLeftY, axisRightX, axisRightY, leftTrigger, rightTrigger} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGamepadGet15Buttons6AxesNumbers(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String gamepadGetName(Number gamepadId0to15) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGamepadGetName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String gamepadGetGUID(Number gamepadId0to15) /* -> String GUID */ {
  ...
  String output = (String)_gsCProcedureGamepadGetGUID(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String boolToString(Bool boolean) /* -> String string */ {
  ...
  String output = (String)_gsCProcedureBoolToString(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String numberToString(Number number) /* -> String string */ {
  ...
  String output = (String)_gsCProcedureNumberToString(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String numberToBinaryString(Number number) /* -> String string */ {
  ...
  String output = (String)_gsCProcedureNumberToBinaryString(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String numberWholePartToString(Number number) /* -> String string */ {
  ...
  String output = (String)_gsCProcedureNumberWholePartToString(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray stringToNumberArray(String string) /* -> Number array [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureStringToNumberArray(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String stringReadFromFile(String filepath) /* -> String string */ {
  ...
  String output = (String)_gsCProcedureStringReadFromFile(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getClipboardString() /* -> String clipboard */ {
  String output = (String)_gsCProcedureGetClipboardString(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray gizmoGetVector(String label) /* -> Number position [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGizmoGetVector(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray gizmoGetVersor(String label) /* -> Number quaternion [4] {x, y, z, w} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGizmoGetVersor(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray gizmoGetScale(String label) /* -> Number scale [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGizmoGetScale(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String meshImporterGetMeshName(String meshFilepath, Number meshIndex) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureMeshImporterGetMeshName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray imageGetColor(Number handle, Number x, Number y) /* -> Number color [4] {r0To255, g0To255, b0To255, a0To255} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureImageGetColor(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
Bool shaderBegin(String label, String filepathShaderVert, String filepathShaderFrag) /* -> Bool shadersAreValid */ {
  void * args[] = {
    (void *)label,
    (void *)filepathShaderVert,
    (void *)filepathShaderFrag,
  };
...
String systemCommand(String command) /* -> String output */ {
  ...
  String output = (String)_gsCProcedureSystemCommand(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getLastDragAndDropFilepath(Number index) /* -> String filepath */ {
  ...
  String output = (String)_gsCProcedureGetLastDragAndDropFilepath(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getGameScriptString() /* -> String script */ {
  String output = (String)_gsCProcedureGetGameScriptString(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getThread2ScriptString() /* -> String script */ {
  String output = (String)_gsCProcedureGetThread2ScriptString(0, 0, 0, 0);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String programGetArgument(Number index) /* -> String argument */ {
  ...
  String output = (String)_gsCProcedureProgramGetArgument(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String globalMeshesGetMeshLabelByMeshIndex(Number index) /* -> String label */ {
  ...
  String output = (String)_gsCProcedureGlobalMeshesGetMeshLabelByMeshIndex(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String globalMeshesPersistentGetMeshLabelByMeshIndex(Number index) /* -> String label */ {
  ...
  String output = (String)_gsCProcedureGlobalMeshesPersistentGetMeshLabelByMeshIndex(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesGetHaveVerticesChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesGetHaveVerticesChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesGetHaveColorsChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesGetHaveColorsChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesGetHaveTexCoordsChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesGetHaveTexCoordsChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesGetHaveIndicesChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesGetHaveIndicesChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesPersistentGetHaveVerticesChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesPersistentGetHaveVerticesChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesPersistentGetHaveColorsChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesPersistentGetHaveColorsChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesPersistentGetHaveTexCoordsChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesPersistentGetHaveTexCoordsChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray globalMeshesPersistentGetHaveIndicesChangedMeshIndexes(Number count) /* -> Number indexes [] */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureGlobalMeshesPersistentGetHaveIndicesChangedMeshIndexes(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String globalKeyPropertyGetKeyLabelByKeyIndex(Number index) /* -> String label */ {
  ...
  String output = (String)_gsCProcedureGlobalKeyPropertyGetKeyLabelByKeyIndex(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String globalKeyPropertyGetKeyPropertyLabelByPropertyIndex(String key, Number index) /* -> String label */ {
  ...
  String output = (String)_gsCProcedureGlobalKeyPropertyGetKeyPropertyLabelByPropertyIndex(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String globalKeyPropertyGetString(String key, String property) /* -> String value */ {
  ...
  String output = (String)_gsCProcedureGlobalKeyPropertyGetString(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray ertPick(Number deviceHandle, Number cameraHandle, Number x, Number y, Number sceneHandle) /* -> Number point [4] {x, y, z, isHit} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureErtPick(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getRedStructName(Number index) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGetRedStructName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getRedStructMemberName(Number index) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGetRedStructMemberName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
Number redCreateProcedure(Number context, Number gpuHandle, String handleName, Number procedureCache, Number outputDeclaration, Number procedureParameters, String gpuCodeVertexMainProcedureName, Number gpuCodeVertex, String gpuCodeFragmentMainProcedureName, Number gpuCodeFragment, Number state, Number stateExtension, Bool deriveBase, Number deriveFrom, Number outStatuses) /* -> Number procedureHandle */ {
  void * args[] = {
    ...
    (void *)gpuCodeVertexMainProcedureName,
    _gsVoidPointerFromNumber(gpuCodeVertex),
    (void *)gpuCodeFragmentMainProcedureName,
...
String getRrtStructName(Number index) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGetRrtStructName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getRrtStructMemberName(Number index) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGetRrtStructMemberName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getXatlasStructName(Number index) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGetXatlasStructName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String getXatlasStructMemberName(Number index) /* -> String name */ {
  ...
  String output = (String)_gsCProcedureGetXatlasStructMemberName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String fbxGetMeshName(Number handle, Number meshIndex) /* -> String meshName */ {
  ...
  String output = (String)_gsCProcedureFbxGetMeshName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String fbxBoneGetName(Number handle) /* -> String boneName */ {
  ...
  String output = (String)_gsCProcedureFbxBoneGetName(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray fbxBoneGetVector(Number handle) /* -> Number position [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureFbxBoneGetVector(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray fbxBoneGetVersor(Number handle) /* -> Number quaternion [4] {x, y, z, w} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureFbxBoneGetVersor(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray fbxBoneGetScale(Number handle) /* -> Number scale [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureFbxBoneGetScale(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray fbxBoneGetSideVector(Number handle) /* -> Number sideVector [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureFbxBoneGetSideVector(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray fbxBoneGetUpVector(Number handle) /* -> Number upVector [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureFbxBoneGetUpVector(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
NumberArray fbxBoneGetLookAtVector(Number handle) /* -> Number lookAtVector [3] {x, y, z} */ {
  ...
  NumberArray output = (NumberArray)_gsCProcedureFbxBoneGetLookAtVector(0, 0, 0, args);
  dynamicArrayAppend(globalDynamicArrayPersistentNew("free"), _gsNumberFromVoidPointer(output));
  return output;
}
...
String strjoin(String a, String b) {
  ...
  uint64_t blen = b == 0 ? 0 : strlen(b);
  String c = (String)malloc(alen + blen + 1);
  for (uint64_t i = 0; i < alen; i += 1) {
    c[i] = a[i];
  }
  for (uint64_t i = 0; i < blen; i += 1) {
    c[alen + i] = b[i];
  }
  c[alen + blen] = 0;
...
void framestart() {
  Number handles = globalDynamicArrayPersistentNew("free");
  uint64_t count = (uint64_t)dynamicArrayGetSize(handles);
  for (uint64_t i = 0; i < count; i += 1) {
    Number handle = dynamicArrayGet(handles, (Number)i);
    free(_gsVoidPointerFromNumber(handle));
  }
  globalDynamicArrayPersistentDelete("free");
}
